    ...
    <nav class="sidebar-main">
      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          ...
          if (isset($_SESSION["adminID"])) {
          ?>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="layout"></i><span class="lan-7">Hospital</span></a>
              <ul class="sidebar-submenu">
                <li><a href="manage-hospital.php">Manage Hospital</a></li>
              </ul>
            </li>
          <?php
          }
